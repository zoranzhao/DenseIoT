...
inline float* req_ir_data_serialization_v2(network net, int part, int startfrom, int upto){
...
inline void req_ir_data_deserialization_v2(network net, int part, float* input, int startfrom, int upto){
      int p_h = part / PARTITIONS_W; 
      int p_w = part % PARTITIONS_W;
