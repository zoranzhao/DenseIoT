...
inline float* req_ir_data_serialization_gateway(network net, int part, int startfrom, int upto, bool* req, unsigned int *size, int cli_id){
      int p_h = part / PARTITIONS_W; 
      int p_w = part % PARTITIONS_W;
      float *output;
      output = (float*)malloc(ir_data_size[part]*sizeof(float));
	...
	if(up[part][i]==1&&req[0]){
		//std::cout << "Serializing the above block of the " << std::endl;
		//print_subindex(ir_output[i][p_h-1][p_w].down_range);
		memcpy(output, ir_output_gateway[i][p_h-1][p_w].down[cli_id], ir_output[i][p_h-1][p_w].down_range.w*ir_output[i][p_h-1][p_w].down_range.h*net.layers[i].out_c*sizeof(float) ); 
		output = output + ir_output[i][p_h-1][p_w].down_range.w*ir_output[i][p_h-1][p_w].down_range.h*net.layers[i].out_c;
		//profile_num += ir_output[i][p_h-1][p_w].down_range.w*ir_output[i][p_h-1][p_w].down_range.h*net.layers[i].out_c;
		//std::cout  << "Shift number is ... "<< profile_num << std::endl;
		*size = *size + ir_output[i][p_h-1][p_w].down_range.w*ir_output[i][p_h-1][p_w].down_range.h*net.layers[i].out_c;
	...
	if(left[part][i]==1&&req[1]){
		//std::cout << "Serializing the left block of the " << std::endl;
		//print_subindex(ir_output[i][p_h][p_w-1].right_range);
		memcpy(output, ir_output_gateway[i][p_h][p_w-1].right[cli_id], ir_output[i][p_h][p_w-1].right_range.w*ir_output[i][p_h][p_w-1].right_range.h*net.layers[i].out_c*sizeof(float) ); 
		output = output + ir_output[i][p_h][p_w-1].right_range.w*ir_output[i][p_h][p_w-1].right_range.h*net.layers[i].out_c;
		//profile_num +=  ir_output[i][p_h][p_w-1].right_range.w*ir_output[i][p_h][p_w-1].right_range.h*net.layers[i].out_c;
		//std::cout  << "Shift number is ... "<< profile_num << std::endl;
		*size = *size + ir_output[i][p_h][p_w-1].right_range.w*ir_output[i][p_h][p_w-1].right_range.h*net.layers[i].out_c;
	...
	if(down[part][i]==1&&req[2]){
		//std::cout << "Serializing the down block of the " << std::endl;
		//print_subindex(ir_output[i][p_h+1][p_w].up_range);
		memcpy(output, ir_output_gateway[i][p_h+1][p_w].up[cli_id], ir_output[i][p_h+1][p_w].up_range.w*ir_output[i][p_h+1][p_w].up_range.h*net.layers[i].out_c*sizeof(float) ); 
		output = output + ir_output[i][p_h+1][p_w].up_range.w*ir_output[i][p_h+1][p_w].up_range.h*net.layers[i].out_c;
		//profile_num +=  ir_output[i][p_h+1][p_w].up_range.w*ir_output[i][p_h+1][p_w].up_range.h*net.layers[i].out_c;
		//std::cout  << "Shift number is ... "<< profile_num << std::endl;
		*size = *size + ir_output[i][p_h+1][p_w].up_range.w*ir_output[i][p_h+1][p_w].up_range.h*net.layers[i].out_c;
	...
	if(right[part][i]==1&&req[3]){
		//std::cout << "Serializing the right block of the " << std::endl;
		//print_subindex(ir_output[i][p_h][p_w+1].left_range);
		memcpy(output, ir_output_gateway[i][p_h][p_w+1].left[cli_id], ir_output[i][p_h][p_w+1].left_range.w*ir_output[i][p_h][p_w+1].left_range.h*net.layers[i].out_c*sizeof(float) ); 
		output = output + ir_output[i][p_h][p_w+1].left_range.w*ir_output[i][p_h][p_w+1].left_range.h*net.layers[i].out_c;
		//profile_num +=  ir_output[i][p_h][p_w+1].left_range.w*ir_output[i][p_h][p_w+1].left_range.h*net.layers[i].out_c;
		//std::cout  << "Shift number is ... "<< profile_num << std::endl;
		*size = *size + ir_output[i][p_h][p_w+1].left_range.w*ir_output[i][p_h][p_w+1].left_range.h*net.layers[i].out_c;
...
inline void result_ir_data_deserialization_gateway(network net, int part, float* input, int startfrom, int upto, int cli_id){
      int p_h = part / PARTITIONS_W; 
      int p_w = part % PARTITIONS_W;
	...
	if(result_up[part][i]==1){
		ir_output_gateway[i][p_h][p_w].up[cli_id] = (float*)malloc(ir_output[i][p_h][p_w].up_range.w*ir_output[i][p_h][p_w].up_range.h*net.layers[i].out_c*sizeof(float));
		memcpy(ir_output_gateway[i][p_h][p_w].up[cli_id], input_data, ir_output[i][p_h][p_w].up_range.w*ir_output[i][p_h][p_w].up_range.h*net.layers[i].out_c*sizeof(float) ); 
	...
	if(result_left[part][i]==1){
		ir_output_gateway[i][p_h][p_w].left[cli_id] = (float*)malloc(ir_output[i][p_h][p_w].left_range.w*ir_output[i][p_h][p_w].left_range.h*net.layers[i].out_c*sizeof(float));
		memcpy(ir_output_gateway[i][p_h][p_w].left[cli_id], input_data, ir_output[i][p_h][p_w].left_range.w*ir_output[i][p_h][p_w].left_range.h*net.layers[i].out_c*sizeof(float) ); 
	...
	if(result_down[part][i]==1){
		ir_output_gateway[i][p_h][p_w].down[cli_id] = (float*)malloc(ir_output[i][p_h][p_w].down_range.w*ir_output[i][p_h][p_w].down_range.h*net.layers[i].out_c*sizeof(float));
		memcpy(ir_output_gateway[i][p_h][p_w].down[cli_id], input_data, ir_output[i][p_h][p_w].down_range.w*ir_output[i][p_h][p_w].down_range.h*net.layers[i].out_c*sizeof(float) ); 
	...
	if(result_right[part][i]==1){
		ir_output_gateway[i][p_h][p_w].right[cli_id] = (float*)malloc(ir_output[i][p_h][p_w].right_range.w*ir_output[i][p_h][p_w].right_range.h*net.layers[i].out_c*sizeof(float));
		memcpy(ir_output_gateway[i][p_h][p_w].right[cli_id], input_data, ir_output[i][p_h][p_w].right_range.w*ir_output[i][p_h][p_w].right_range.h*net.layers[i].out_c*sizeof(float) ); 
